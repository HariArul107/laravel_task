                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="/item/edit/{{ $item->item_id }}?edit=1" class="edit" title="Edit">✏️</a>
                            <a href="/item/delete/{{ $item->item_id}}" class="delete"
                                onclick="return confirm('Are you sure?')" title="Delete">🗑️</a>
                            <a href="/item/edit/{{ $item->item_id }}" class="view" title="View">
            ...
            $('#itemsTable').DataTable({
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, row, meta) {
                        return meta.row + 1; // auto numbering starting from 1
                    }
                }]
            });
        });
