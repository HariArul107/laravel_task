...
<body>
    ...
    <div class="form-container">
        ...
        <form action="/purchase/update/{{ $purchase->purchase_id }}" method="POST">
            ...
            <label for="supplier_name">suppliername</label>
            <input type="text" id="supplier_name" name="supplier_name" value="{{ $purchase->supplier_name}}" @if(!$editable) readonly @endif required>
            <br><br>

            <label for="purchase_date">purchase_date</label>
            <input type="date" id="purchase_date" name="purchase_date" value="{{ $purchase->purchase_date}}" @if(!$editable) readonly @endif required>
            <br><br>

            <label for="address">Address:</label>
            <textarea id="address" name="address" @if(!$editable) readonly @endif required>{{ $purchase->address}} </textarea>
            <br><br>

            <label>Quantity:</label>
            <input type="number" id="quantity" name="quantity"
                value="{{ $purchase->quantity }}"
                @if(!$editable) readonly @endif min="1" max="9999">
