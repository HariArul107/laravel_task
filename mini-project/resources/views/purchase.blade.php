        ...
        <table id="purchaseTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $pas->total_quantity }}</td>
                    <td>{{ $pas->quantity }}</td>
                    <td>{{ $pas->total_price}}</td>
                    <td>
                        <div class="action-buttons">
                            <a href="/purchase/edit/{{ $pas->purchase_id }}?edit=1" class="edit" title="Edit">✏️</a>
                            <a href="/purchase/delete/{{ $pas->purchase_id }}" class="delete"
                                onclick="return confirm('Are you sure you want to delete this purchase?')">🗑️</a>
                            <a href="/purchase/edit/{{ $pas->purchase_id }}" class="view" title="View">
                ...
                @empty
                <tr>
                    <td colspan="6" class="empty-message">No purchases found</td>
                </tr>
                @endforelse
            </tbody>
        </table>
